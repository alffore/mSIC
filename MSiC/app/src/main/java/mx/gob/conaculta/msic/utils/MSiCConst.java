...
public class MSiCConst {
    ...
    public static final String[] MT_ARRAY_MOD = {"museo", "teatro", "centro_cultural", "libreria", "galeria", "biblioteca"};


    //URLs solicitudes
    public static final String SDBSIC_BASE_URL = "http://msic.conaculta.gob.mx/app/infra2.php?";
    public static final String SFICHA_URL = "http://devsic.sic.gob.mx/ficha.php?";
